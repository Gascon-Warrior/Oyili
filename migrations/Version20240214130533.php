 ...
 */
final class Version20240214130533 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video_worker (video_id INT NOT NULL, worker_id INT NOT NULL, INDEX IDX_A7E51FAF6B20BA36 (worker_id), INDEX IDX_A7E51FAF29C1004E (video_id), PRIMARY KEY(video_id, worker_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
